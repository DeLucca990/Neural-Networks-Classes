...
## Código Fonte
- Notebook de exploração e modelagem: `code/projects/02-Regression/main.ipynb`
...
![Evolução dos Preços por Produto](../assets/projects/02/products_price.png)
...
![Preços Gasolina Comum - Nordeste](../assets/projects/02/north_east_gas_price.png)
...
![Curva de Perda MLP](../assets/projects/02/mlp_loss.png)
...
![Valores Reais vs Previstos](../assets/projects/02/mlp_linearreg_reg.png)
...
![Resíduos vs Predições](../assets/projects/02/mlp_linearreg_waste.png)
...
![Distribuição dos Resíduos](../assets/projects/02/mlp_linearreg_hist.png)
